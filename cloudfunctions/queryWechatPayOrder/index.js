// cloudfunctions/queryWechatPayOrder/index.js
// 微信支付 V3 查询订单：核实真实支付状态后更新订单（替代原「信任模式」）
// 环境变量同 createWechatPayOrder：MCH_ID / MCH_SERIAL_NO / MERCHANT_PRIVATE_KEY_B64
...
exports.main = async (event, context) => {
  ...
  try {
    ...
    return {
      code: 1006,
      message: '订单未支付',
      data: { paid: false, tradeState: result.trade_state }
    };
  } catch (err) {
    console.error('查询支付订单异常:', err);
